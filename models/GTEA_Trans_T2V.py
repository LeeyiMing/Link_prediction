...
class GTEATransT2VLayer(nn.Module):
    def __init__(self, node_in_dim, node_hidden_dim, edge_in_dim, time_hidden_dim, num_heads, num_time_layers, drop_prob, device):
        super(GTEATransT2VLayer, self).__init__()
        ...
        self.edge_in_layer = nn.Linear(edge_in_dim + time_hidden_dim, node_hidden_dim)
...
class GTEATransT2V(nn.Module):
    def __init__(self, num_nodes, node_in_dim, node_hidden_dim, edge_in_dim, time_hidden_dim, num_class, num_layers, num_heads, num_time_layers, device, drop_prob=0):
        super(GTEATransT2V, self).__init__()
        ...
        self.gcn_layers.append(GTEATransT2VLayer(node_in_dim, node_hidden_dim, edge_in_dim, time_hidden_dim, num_heads, num_time_layers, drop_prob, device))
